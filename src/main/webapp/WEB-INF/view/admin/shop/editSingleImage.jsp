    ...
    <div class="content">
        ...
        <div class="list-content">
            ...
            <div class="block">
                <!--修饰块元素名称-->
                <div class="banner">
                    <p class="tab fixed">上传商品单个图片<span class="hint">Product Editors</span></p>
                    ...
                    <form id="form" action="" method="">
                        <div id="zhl_admin_box" class="zhl_admin_update_more"> <!-- 在这里更改class选择器名称，显示不同的样式-->
                            <div id="zhl_admin_update">
                                ...
                                <c:choose>
                                <c:when test="${fn:length(singleList)==0}">
                                </c:when>
                                <c:otherwise>
                                <span id="zhl_admin_imgs1">
                                        <c:forEach items="${singleList}" var="entity" varStatus="status" >
                                ...
                                <span id="zhl_update_hint">（点击图片删除）最多传5张</span>
                            </div>
                        </div>
                    </form>
                </div>
